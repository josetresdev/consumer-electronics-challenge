...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
        /* =========================
        TAILWIND BASE MINIMAL FIX
        ========================= */

        /* CSS reset base (lightweight safe fallback) */
        *, *::before, *::after {
        ...
        /* Root variables (Tailwind essentials only) */
        :root {
        ...
        /* Utility helpers (only what your layout actually uses) */
        .flex { display: flex; }
        .grid { display: grid; }
        .hidden { display: none; }
    ...
    <body class="bg-[#F4F6F9] dark:bg-[#0a0a0a] text-[#1b1b18] min-h-screen flex flex-col">

        {{-- HEADER --}}
        <header class="w-full bg-white dark:bg-[#0f0f0f] border-b border-[#e5e7eb] dark:border-[#2a2a2a]">
            <div class="max-w-6xl mx-auto flex items-center justify-between px-6 py-3">

                {{-- TITLE --}}
                <div class="flex items-center gap-3">
                    <div class="w-9 h-9 rounded bg-[#4a90e2]"></div>
                    <div>
                        <p class="text-sm font-semibold">Panel de Productos</p>
                        <p class="text-xs text-gray-500">Gestión de inventario</p>
                    </div>
                </div>
                ...
                <nav class="flex items-center gap-3 text-sm">
                    ...
                    @auth
                        ...
                        class="px-4 py-1.5 rounded border border-transparent hover:border-gray-300 dark:hover:border-gray-600 transition">
                            Dashboard
                        </a>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit"
                                    class="px-4 py-1.5 rounded bg-red-500 text-white hover:bg-red-600 transition">
                                Cerrar sesión
                            </button>
                        </form>
                    @else
                        <a href="{{ route('login') }}"
                        class="px-4 py-1.5 rounded border hover:border-gray-300 dark:hover:border-gray-600 transition">
                            Iniciar sesión
                        </a>
                    @endauth
        ...
        <main class="flex-1 flex items-center justify-center px-6 py-10">
            ...
            <div class="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {{-- INFO PANEL --}}
                <div class="bg-white dark:bg-[#161615] border border-[#e5e7eb] dark:border-[#2a2a2a] rounded-xl p-8">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">
                        Administra inventario, precios, stock y estados de productos del sistema.
                    </p>

                    <ul class="text-sm space-y-2">
                        <li>• Crear, editar y eliminar productos</li>
                        <li>• Control de stock en tiempo real</li>
                        <li>• Estados: disponible, reservado, disposición</li>
                        <li>• Registro de lotes y fabricación</li>
                    </ul>

                </div>

                {{-- QUICK ACTION / EMPTY PANEL --}}
                <div class="bg-white dark:bg-[#161615] border border-[#e5e7eb] dark:border-[#2a2a2a] rounded-xl p-8">
                    ...
                    <div class="space-y-3">
                        ...
                        class="block w-full text-center px-4 py-2 rounded bg-[#4a90e2] text-white hover:opacity-90 transition">
                            + Nuevo producto
                        </a>

                        <a href="{{ route('products.index') }}"
                        class="block w-full text-center px-4 py-2 rounded border hover:border-gray-400 dark:hover:border-gray-600 transition">
                            Ver listado
                        </a>
                    ...
                    <div class="mt-6 text-xs text-gray-500">
                        Sistema preparado para escalar inventario multi-módulo
                    </div>
